...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '25456738f9f1809f9d79dd85bb02ce6e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Anurag Sawant', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'I Write.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.anuragsawant.in', // 网站地址
